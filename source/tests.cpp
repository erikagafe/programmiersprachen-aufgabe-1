...
int checksum(int num) {
    // the digit sum of a given integer is the sum of all its digits (e.g. the digit sum of 84001 is calculated as 8+4+0+0+1 = 13).
...
TEST_CASE("describe_fract", "[fract]") {
    REQUIRE(fract(14.395) == Approx(0.395f).epsilon(0.01));
}
